...
export default function Grafico({titulo, data, dataKey1, dataKey2, dataKey3, dataKey4, dataKey5, grid}) {
  ...
  return (
    <div className="grafico">
      ...
      <ResponsiveContainer width="99%" aspect={4 / 1}>
          <LineChart data={data}>
              <XAxis dataKey={dataKey5} stroke="#5550bd" />
              <YAxis/>
              ...
              <Line type="monotone" dataKey={dataKey4} stroke="#FF0000" />
              <Tooltip />
